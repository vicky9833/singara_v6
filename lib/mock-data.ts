...
const MOCK_ARTISTS: Artist[] = [
  ...
  },
  {
    ...
    photoUrl: null,
    bio: 'From smoky editorials to the perfect party-night glam, I thrive on creative looks that push boundaries while staying wearable. Trained at VLCC and worked with leading fashion photographers in Mumbai and Bangalore.',
    city: 'Bangalore',
    area: 'Indiranagar',
  ...
  },
  {
    ...
    photoUrl: null,
    bio: 'With 15 years of experience specializing in South Indian and pan-Indian bridal looks, I bring an encyclopedic knowledge of regional bridal traditions. Currently traveling in Bangalore for the season — take advantage of my limited availability.',
    city: 'Hyderabad',
    area: 'Jubilee Hills',
    ...
    reviews: [
      ...
      },
      {
        ...
        customerPhotoUrl: null,
        rating: 5,
        text: 'She traveled all the way from Hyderabad for my wedding. Worth every rupee. The look was flawless and she stayed until the ceremony started just to touch up.',
        date: '2024-01-15',
        serviceCategory: 'bridal',
      },
      {
